                ...
                <div className="mt-8 w-full max-w-[240px]">
                  ...
                  <div className="grid grid-cols-3 gap-6 mb-2 relative z-50">
                     ...
                     <div className="group relative bg-pro-card py-4 px-6 rounded-2xl border border-pro-border flex justify-between items-center shadow-sm cursor-help">
                       ...
                       <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-56 p-2 bg-pro-text text-pro-bg text-sm font-bold text-center rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 pointer-events-none shadow-xl">
                         Your overall memorization score for the selected frets. 100% means you know every note instantly without making mistakes.
                         <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-pro-text"></div>
                       </div>
                     </div>                  </div>        </div>
      </main>
